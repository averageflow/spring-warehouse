...
Joe's Warehouse Software is a Java Spring Boot application that has the purpose of managing products and articles in your warehouse.
...
This application provides several endpoints for "headless" usage (without frontend).
